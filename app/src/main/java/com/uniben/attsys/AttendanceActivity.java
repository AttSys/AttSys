...
import com.uniben.attsys.geolocation.GeofenceErrorMessages;
 ...
 * <p>
 */
public class AttendanceActivity extends AppCompatActivity implements OnCompleteListener<Void> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        student = getIntent().getParcelableExtra(Constants.STUDENT_KEY);
    ...
    private void addGeofences() {
        if (!checkPermissions()) {
            NotificationUtils.notifyUser(this, getString(R.string.insufficient_permissions));
            return;
        }
    ...
    private void populateGeofenceList() {
        ...
        Venue venue = student.getAttendanceList().get(0).getVenue();
